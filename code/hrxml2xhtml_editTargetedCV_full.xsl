...
-->
 ...
 <xsl:template match="/">
   ...
   <xsl:if test="position() = $position">
    <xsl:variable name="candidateProfilePath">/hr:Candidate/hr:CandidateProfile(<xsl:number/>)</xsl:variable>
     <div id="EuropassCV">
      <div id="EuropassCV_Header">
       <a href="http://europass.cedefop.europa.eu/" target="_blank" title="Europass web-site">
        <img src="_htReqsURL_/icons/europass.png"/></a>
      </div>
      <div class="EuropassCV_ContentLine">
       ...
       <div class="EuropassCV_Content">
        <p>__(Name of this view:)
         <input type="text" onChange="javascript:this.form.submit()">
          <xsl:attribute name="name"><xsl:value-of select="$candidateProfilePath"/>/hr:ProfileName</xsl:attribute>
          <xsl:attribute name="value"><xsl:value-of select="hr:ProfileName"/></xsl:attribute>
         </input>
        </p>
       </div>
     </div>
      ...
      <xsl:choose>
       <xsl:when test="hr:UserArea/hr:DisplayPhoto">
        <div class="KiteCV_deletable">
         <xsl:attribute name="title"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:DisplayPhoto</xsl:attribute>
          <img style="background-color: #eee; border: outset thin black; width: 100px; height: 100px; text-align:center;" src="_exportURL_?position=0&amp;format=photo"/>
        </div>
       </xsl:when>
       <xsl:otherwise>
        <div class="KiteCV_adder">
         <button type="button">__(Display the photo)</button>
         <div class="KiteCV_adder_content">
          <input type="hidden" value="1">
           <xsl:attribute name="name"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:DisplayPhoto</xsl:attribute>
          </input>
          <img style="background-color: #eee; border: outset thin black; width: 100px; height: 100px; text-align:center;" src="_exportURL_?position=0&amp;format=photo"/>
         </div>
        </div>
     ...
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       <xsl:call-template name="copyLineInput">
        <xsl:with-param name="name"><xsl:value-of select="$candidateProfilePath"/>/hr:PersonalData/hr:PersonName/hr:FormattedName</xsl:with-param>
        <xsl:with-param name="value"><xsl:value-of select="hr:PersonalData/hr:PersonName/hr:FormattedName"/></xsl:with-param>
        <xsl:with-param name="sourceValue"><xsl:value-of select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:ContactInfo/hr:PersonName/hr:FormattedName"/></xsl:with-param>
       </xsl:call-template>
      </div>
     </div>
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       ...
       <div class="KiteCV_adder">
        ...
        <xsl:variable name="newAddressPath"><xsl:value-of select="$candidateProfilePath"/>/hr:ContactInfo/hr:ContactMethod/hr:PostalAddress(<xsl:value-of select="count(hr:ContactInfo/hr:ContactMethod/hr:PostalAddress) + 1"/>)</xsl:variable>
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:ContactInfo/hr:ContactMethod/hr:PostalAddress">
         <div class="KiteCV_adder_content">
          <xsl:call-template name="postalAddress">
      ...
      <div class="EuropassCV_Content">
       ...
       <div class="KiteCV_adder">
        ...
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:ContactInfo/hr:ContactMethod[hr:Telephone]">
         <div class="KiteCV_adder_content">
          <input type="text" class="wide">
           <xsl:attribute name="name"><xsl:value-of select="$newContactMethodPath"/>/hr:Telephone/hr:FormattedNumber</xsl:attribute>
           <xsl:attribute name="value"><xsl:value-of select="hr:Telephone/hr:FormattedNumber"/></xsl:attribute>
          </input>
         </div>
        </xsl:for-each>
      ...
      <div class="EuropassCV_Content">
       ...
       <div class="KiteCV_adder">
        ...
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:ContactInfo/hr:ContactMethod[hr:Fax]">
         <div class="KiteCV_adder_content">
          <input type="text" class="wide">
           <xsl:attribute name="name"><xsl:value-of select="$newContactMethodPath"/>/hr:Fax/hr:FormattedNumber</xsl:attribute>
           <xsl:attribute name="value"><xsl:value-of select="hr:Fax/hr:FormattedNumber"/></xsl:attribute>
          </input>
         </div>
        </xsl:for-each>
      ...
      <div class="EuropassCV_Content">
       ...
       <div class="KiteCV_adder">
        ...
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:ContactInfo/hr:ContactMethod[hr:InternetEmailAddress]">
         <div class="KiteCV_adder_content">
          <input type="text" class="wide">
           <xsl:attribute name="name"><xsl:value-of select="$newContactMethodPath"/>/hr:InternetEmailAddress</xsl:attribute>
           <xsl:attribute name="value"><xsl:value-of select="hr:InternetEmailAddress"/></xsl:attribute>
          </input>
         </div>
        </xsl:for-each>
     ...
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       ...
       <div class="KiteCV_adder">
        ...
        <xsl:variable name="newNationalityPath"><xsl:value-of select="$candidateProfilePath"/>/hr:PersonalData/hr:PersonDescriptors/hr:DemographicDescriptors/hr:Nationality(<xsl:value-of select="count(hr:PersonalData/hr:PersonDescriptors/hr:DemographicDescriptors/hr:Nationality) + 1"/>)</xsl:variable>
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:UserArea/hr:Nationality">
         <div class="KiteCV_adder_content">
          <input type="text" class="wide">
           <xsl:attribute name="name"><xsl:value-of select="$newNationalityPath"/></xsl:attribute>
           <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
          </input>
         </div>
        </xsl:for-each>
     ...
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       <xsl:call-template name="copyDateInput">
        <xsl:with-param name="name"><xsl:value-of select="$candidateProfilePath"/>/hr:PersonalData/hr:PersonDescriptors/hr:BiologicalDescriptors/hr:DateOfBirth</xsl:with-param>
        <xsl:with-param name="value"><xsl:value-of select="hr:PersonalData/hr:PersonDescriptors/hr:BiologicalDescriptors/hr:DateOfBirth"/></xsl:with-param>
        <xsl:with-param name="sourceValue"><xsl:value-of select="/hr:Candidate/hr:Resume/hr:UserArea/hr:DateOfBirth/hr:AnyDate"/></xsl:with-param>
       </xsl:call-template>
      </div>
     </div>
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       <xsl:variable name="genderCodes">
        <c code="1" label="__(M)"/>
        <c code="2" label="__(F)"/>
        <c code="3" label="__(Not specified)"/>
       </xsl:variable>
       <xsl:for-each select="exslt:node-set($genderCodes)/*">
        <input type="radio">
         <xsl:attribute name="name"><xsl:value-of select="$candidateProfilePath"/>/hr:PersonalData/hr:PersonDescriptors/hr:BiologicalDescriptors/hr:GenderCode</xsl:attribute>
     ...
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       <xsl:call-template name="copyLineInput">
        <xsl:with-param name="name"><xsl:value-of select="$candidateProfilePath"/>/hr:PreferredPosition/hr:PositionTitle</xsl:with-param>
        <xsl:with-param name="value"><xsl:value-of select="hr:PreferredPosition/hr:PositionTitle"/></xsl:with-param>
        <xsl:with-param name="sourceValue"><xsl:value-of select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:Objective"/></xsl:with-param>
       </xsl:call-template>
      </div>
     </div>
     ...
     <div class="KiteCV_adder">
      ...
      <xsl:variable name="newWorkExperiencePath"><xsl:value-of select="$candidateProfilePath"/>/hr:EmploymentHistory/hr:EmployerOrg(<xsl:value-of select="count(hr:EmploymentHistory/hr:EmployerOrg) + 1"/>)</xsl:variable>
      <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:EmploymentHistory/hr:EmployerOrg">
       <div class="KiteCV_adder_content">
        <xsl:call-template name="workExperience">
         <xsl:with-param name="path"><xsl:value-of select="$newWorkExperiencePath"/></xsl:with-param>
         <xsl:with-param name="node"><xsl:copy-of select="."/></xsl:with-param>
        </xsl:call-template>
       </div>
      </xsl:for-each>
     ...
     <xsl:for-each select="hr:EducationHistory/hr:SchoolOrInstitution">
      ...
      <div class="KiteCV_deletable">
       <xsl:attribute name="title"><xsl:value-of select="$schoolOrInstitutionPath"/></xsl:attribute>
      ...
      <div class="KiteCV_adder">
       ...
       <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:EducationHistory/hr:SchoolOrInstitution">
        <div class="KiteCV_adder_content">
         <xsl:call-template name="degree">
          <xsl:with-param name="path"><xsl:value-of select="$newDegreePath"/></xsl:with-param>
          <xsl:with-param name="node"><xsl:copy-of select="."/></xsl:with-param>
         </xsl:call-template>
        </div>
       </xsl:for-each>
     ...
     <div class="EuropassCV_ContentLineNewSection multi-part" title="__(Languages)">
      <div class="EuropassCV_HeaderColumn EuropassCV_SectionTitle">
       __(Personal skills and competences (language part))
      </div>
     ...
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       <xsl:for-each select="hr:UserArea/hr:MotherLanguages/hr:MotherLanguage">
        <xsl:variable name="motherLanguagePath"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:MotherLanguages/hr:MotherLanguage(<xsl:number/>)</xsl:variable>
        <div class="KiteCV_deletable">
       ...
       <xsl:variable name="newMotherLanguagePath"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:MotherLanguages/hr:MotherLanguage(<xsl:value-of select="count(hr:UserArea/hr:MotherLanguages/hr:MotherLanguage) + 1"/>)</xsl:variable>
       <div class="KiteCV_adder">
        <select>
        ...
        <xsl:for-each select="exslt:node-set($availableNewMotherLanguages)/*">
         <div class="KiteCV_adder_content">
          <input type="hidden">
           <xsl:attribute name="name"><xsl:value-of select="$newMotherLanguagePath"/></xsl:attribute>
           <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
          </input>
          <xsl:call-template name="languageName">
           <xsl:with-param name="code"><xsl:value-of select="."/></xsl:with-param>
     ...
     <xsl:for-each select="hr:UserArea/hr:OtherLanguages/hr:OtherLanguage">
      ...
      <xsl:call-template name="otherLanguage">
       <xsl:with-param name="path">
        <xsl:value-of select="$otherLanguagePath"/>
       </xsl:with-param>
       <xsl:with-param name="node">
        <xsl:copy-of select="."/>
       </xsl:with-param>
     ...
     <div class="KiteCV_adder">
      <select>
       ...
       <xsl:for-each select="/hr:Candidate/hr:Resume/hr:UserArea/hr:OtherLanguages/hr:OtherLanguage">
        <option>
         <xsl:call-template name="languageName">
          <xsl:with-param name="code"><xsl:value-of select="hr:CompetencyId/@id"/></xsl:with-param>
         </xsl:call-template>
        </option>
       </xsl:for-each>
      </select>
      <xsl:variable name="newOtherLanguagePath"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:OtherLanguages/hr:OtherLanguage(<xsl:value-of select="count(hr:UserArea/hr:OtherLanguages/hr:OtherLanguage) + 1"/>)</xsl:variable>
      <xsl:for-each select="/hr:Candidate/hr:Resume/hr:UserArea/hr:OtherLanguages/hr:OtherLanguage">
       <div class="KiteCV_adder_content">
        <xsl:call-template name="otherLanguage">
         <xsl:with-param name="path">
     ...
     <div class="EuropassCV_ContentLineNewSection multi-part" title="Other Competences">
      <div class="EuropassCV_HeaderColumn EuropassCV_SectionTitle">
       __(Personal skills and competences (other parts))
      </div>
     ...
     <xsl:call-template name="competencySection">
      ...
      <xsl:with-param name="candidateProfilePath"><xsl:value-of select="$candidateProfilePath"/></xsl:with-param>
     </xsl:call-template>
     ...
     <div class="EuropassCV_ContentLineNewSection multi-part" title="__(Additional Information)">
      ...
      <div class="EuropassCV_Content">
       <xsl:for-each select="hr:UserArea/hr:AdditionalInformations/hr:AdditionalInformation">
        <xsl:variable name="additionalInformationPath"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:AdditionalInformations/hr:AdditionalInformation(<xsl:number/>)</xsl:variable>
        <div class="KiteCV_deletable">
         <xsl:attribute name="title"><xsl:value-of select="$additionalInformationPath"/></xsl:attribute>
        <textarea class="wide">
         <xsl:attribute name="name"><xsl:value-of select="$additionalInformationPath"/>/hr:Description</xsl:attribute>
  ...
  <xsl:text> </xsl:text>
       ...
       <div class="KiteCV_adder">
        <select>
         <option>__(Add an information)</option>
        ...
        <xsl:variable name="newAdditionalInformationPath"><xsl:value-of select="$candidateProfilePath"/>/hr:UserArea/hr:AdditionalInformations/hr:AdditionalInformation(<xsl:value-of select="count(hr:UserArea/hr:AdditionalInformations/hr:AdditionalInformation) + 1"/>)</xsl:variable>
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:ResumeAdditionalItems/hr:ResumeAdditionalItem">
         <div class="KiteCV_adder_content">
          <textarea class="wide">
           <xsl:attribute name="name"><xsl:value-of select="$newAdditionalInformationPath"/>/hr:Description</xsl:attribute>
           <xsl:value-of select="hr:Description"/>
    <xsl:text> </xsl:text>
          </textarea>
         </div>
      ...
      <div class="EuropassCV_Content">
       <xsl:for-each select="hr:SupportingMaterials">
        ...
        <xsl:call-template name="supportingMaterials">
         <xsl:with-param name="path"><xsl:value-of select="$supportingMaterialsPath"/></xsl:with-param>
         <xsl:with-param name="node"><xsl:copy-of select="."/></xsl:with-param>
        </xsl:call-template>
        </div>
       </xsl:for-each>
       ...
       <div class="KiteCV_adder">
        ...
        <xsl:variable name="newSupportingMaterialsPath"><xsl:value-of select="$candidateProfilePath"/>/hr:SupportingMaterials(<xsl:value-of select="count(hr:SupportingMaterials) + 1"/>)</xsl:variable>
        <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:SupportingMaterials">
         <div class="KiteCV_adder_content">
          <br/>
          <xsl:call-template name="supportingMaterials">
           <xsl:with-param name="path"><xsl:value-of select="$newSupportingMaterialsPath"/></xsl:with-param>
           <xsl:with-param name="node"><xsl:copy-of select="."/></xsl:with-param>
          </xsl:call-template>
         </div>
        </xsl:for-each>
 ...
 <xsl:template name="supportingMaterials">
  ...
  <xsl:for-each select="exslt:node-set($node)/*">
   ...
   <br/>
   <input type="text" class="wide">
    <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:Description</xsl:attribute>
   ...
   <br/>
   <input type="text" class="wide">
    <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:Link</xsl:attribute>
 ...
 <xsl:template name="otherLanguage">
  ...
  <xsl:for-each select="exslt:node-set($node)/*">
   <div class="EuropassCV_ContentLine">
    <div class="EuropassCV_HeaderColumn">
     <select>
      <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:CompetencyId/@id</xsl:attribute>
    ...
    <div class="EuropassCV_Content">
     <table>
      <tr>
       <td width="20%">
        <select>
         <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:CompetencyEvidence(@id='listen')/hr:StringValue</xsl:attribute>
       ...
       <td width="20%">
        <select>
         <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:CompetencyEvidence(@id='read')/hr:StringValue</xsl:attribute>
         <xsl:call-template name="ELPSelectOptions">
       ...
       <td width="20%">
        <select>
         <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:CompetencyEvidence(@id='talk')/hr:StringValue</xsl:attribute>
         <xsl:call-template name="ELPSelectOptions">
       ...
       <td width="20%">
        <select>
         <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:CompetencyEvidence(@id='speech')/hr:StringValue</xsl:attribute>
         <xsl:call-template name="ELPSelectOptions">
       ...
       <td width="20%">
        <select>
         <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:CompetencyEvidence(@id='write')/hr:StringValue</xsl:attribute>
         <xsl:call-template name="ELPSelectOptions">
   ...
   <div class="EuropassCV_Content">
    ...
    <div class="KiteCV_adder">
     ...
     <xsl:for-each select="/hr:Candidate/hr:Resume/hr:StructuredXMLResume/hr:Qualifications/hr:Competency[@name=$name]">
      <div class="KiteCV_adder_content">
       <xsl:call-template name="competencyTextarea">
        <xsl:with-param name="path"><xsl:value-of select="$newCompetencyPath"/></xsl:with-param>
        <xsl:with-param name="value"><xsl:value-of select="@description"/></xsl:with-param>
       </xsl:call-template>
      </div>
     </xsl:for-each>
 ...
 <xsl:template name="dateInput">
  ...
  <button type="reset">
   <xsl:attribute name="id">button_<xsl:value-of select="$name"/></xsl:attribute>
   ...
  </button>
 ...
 <xsl:template name="postalAddress">
  ...
  <xsl:for-each select="exslt:node-set($node)/hr:PostalAddress/hr:DeliveryAddress/hr:AddressLine">
   ...
   <input type="text" class="wide">
    <xsl:attribute name="name"><xsl:value-of select="$addressLinePath"/></xsl:attribute>
    <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
   </input>
   </div>
  </xsl:for-each>
 ...
 <xsl:template name="degree">
  ...
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    ...
    <br/>
    <xsl:call-template name="copyDateInput">
     <xsl:with-param name="name"><xsl:value-of select="$path"/>/hr:Degree/hr:DatesOfAttendance(1)/hr:StartDate/hr:AnyDate</xsl:with-param>
     <xsl:with-param name="value"><xsl:value-of select="exslt:node-set($node)/hr:SchoolOrInstitution/hr:Degree/hr:DatesOfAttendance[1]/hr:StartDate/hr:AnyDate"/></xsl:with-param>
    </xsl:call-template>
    <br/>
    <label>__(End date)</label>
    <br/>
    <xsl:call-template name="copyDateInput">
     <xsl:with-param name="name"><xsl:value-of select="$path"/>/hr:Degree/hr:DatesOfAttendance(1)/hr:EndDate/hr:AnyDate</xsl:with-param>
     <xsl:with-param name="value"><xsl:value-of select="exslt:node-set($node)/hr:SchoolOrInstitution/hr:Degree/hr:DatesOfAttendance[1]/hr:EndDate/hr:AnyDate"/></xsl:with-param>
    </xsl:call-template>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    <input type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:Degree/hr:DegreeName</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:SchoolOrInstitution/hr:Degree/hr:DegreeName"/></xsl:attribute>
    </input>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    <textarea type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:Degree/hr:Comments</xsl:attribute>
  ...
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    <input type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:School/hr:SchoolName</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:SchoolOrInstitution/hr:School/hr:SchoolName"/></xsl:attribute>
    </input>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    ...
    <br/>
    <input type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:Degree/hr:UserArea/hr:ReferenceLevel</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:SchoolOrInstitution/hr:Degree/hr:UserArea/hr:ReferenceLevel"/></xsl:attribute>
    </input>
    <br/>
    <label>__(Reference classification system name)</label>
    <input type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:Degree/hr:UserArea/hr:ReferenceLevel/@referenceType</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:SchoolOrInstitution/hr:Degree/hr:UserArea/hr:ReferenceLevel/@referenceType"/></xsl:attribute>
    </input>
   </div>
  </div>
 </xsl:template>
 ...
 <xsl:template name="workExperience">
  ...
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    ...
    <br/>
    <xsl:call-template name="copyDateInput">
     <xsl:with-param name="name"><xsl:value-of select="$path"/>/hr:PositionHistory(1)/hr:StartDate/hr:AnyDate</xsl:with-param>
     <xsl:with-param name="value"><xsl:value-of select="exslt:node-set($node)/hr:EmployerOrg/hr:PositionHistory[1]/hr:StartDate/hr:AnyDate"/></xsl:with-param>
    </xsl:call-template>
    <br/>
    <label>__(End date)</label>
    <br/>
    <xsl:call-template name="copyDateInput">
     <xsl:with-param name="name"><xsl:value-of select="$path"/>/hr:PositionHistory(1)/hr:EndDate/hr:AnyDate</xsl:with-param>
     <xsl:with-param name="value"><xsl:value-of select="exslt:node-set($node)/hr:EmployerOrg/hr:PositionHistory[1]/hr:EndDate/hr:AnyDate"/></xsl:with-param>
    </xsl:call-template>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    <input type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:PositionHistory/hr:Title</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:EmployerOrg/hr:PositionHistory/hr:Title"/></xsl:attribute>
    </input>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    <textarea type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:PositionHistory/hr:Description</xsl:attribute>
  ...
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    ...
    <br/>
    <input type="hidden">
    <xsl:attribute name="id"><xsl:value-of select="$path"/>/hr:PositionHistory(1)/hr:OrgName/hr:OrganizationName</xsl:attribute>
    <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:PositionHistory(1)/hr:OrgName/hr:OrganizationName</xsl:attribute>
    ...
    <input type="text" class="wide">
     ...
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:EmployerOrgName</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:EmployerOrg/hr:EmployerOrgName"/></xsl:attribute>
    </input>
    <br/>
    <label>__(Organisation address)</label>
    <xsl:call-template name="postalAddress">
     <xsl:with-param name="path"><xsl:value-of select="$path"/>/hr:EmployerContactInfo/hr:ContactMethod/hr:PostalAddress</xsl:with-param>
     <xsl:with-param name="node"><xsl:copy-of select="exslt:node-set($node)/hr:EmployerOrg/hr:EmployerContactInfo/hr:ContactMethod/hr:PostalAddress"/></xsl:with-param>
    </xsl:call-template>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
    <input type="text" class="wide">
     <xsl:attribute name="name"><xsl:value-of select="$path"/>/hr:PositionHistory(1)/hr:OrgIndustry(1)/hr:IndustryDescription</xsl:attribute>
     <xsl:attribute name="value"><xsl:value-of select="exslt:node-set($node)/hr:EmployerOrg/hr:PositionHistory[1]/hr:OrgIndustry[1]/hr:IndustryDescription"/></xsl:attribute>
    </input>
   </div>
  </div>
 </xsl:template>
 ...
 <xsl:template name="copyLineInput">
  ...
  <xsl:choose>
   ...
   <xsl:otherwise>
    <button type="button" class="halfwide">
     <xsl:attribute name="onClick">javascript:setValue('<xsl:value-of select="$name"/>','<xsl:value-of select="$sourceValue"/>', this)</xsl:attribute>
     <xsl:value-of select="$sourceValue"/>
    </button>
   </xsl:otherwise>
