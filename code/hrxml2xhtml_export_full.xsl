...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:hr="http://ns.hr-xml.org/2006-02-28" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:iso="http://www.iso.org/" xmlns:exslt="http://exslt.org/common" xmlns:str="http://exslt.org/strings" xmlns:php="http://php.net/xsl" version="1.0" exclude-result-prefixes="xsl hr xi xsd #default iso exslt str">
<!--
...
div#EuropassCV ul {
  ...
  <xsl:for-each select="/hr:Candidate/hr:CandidateProfile">
    <xsl:if test="position() = $position">
     <div id="EuropassCV">
      ...
      <img style="position: absolute; right: 0; top: 0; background-color: #eee; border: outset thin black; width: 100px; height: 100px; text-align:center;" src="_exportURL_?position=0&amp;format=photo"/>

     <div class="EuropassCV_ContentLineNewSection">
    ...
    <xsl:if test="hr:EducationHistory/hr:SchoolOrInstitution">
     ...
     <div class="EuropassCV_ContentLineNewSection">
      <div class="EuropassCV_HeaderColumn EuropassCV_SectionTitle">
       __(Personal skills and competences)
      </div>
     </div>
    ...
    <xsl:if test="hr:UserArea/hr:OtherLanguages/hr:OtherLanguage">
     ...
     <div class="EuropassCV_ContentLine">
      ...
      <div class="EuropassCV_Content">
       <i><a href="http://culture2.coe.int/portfolio/inc.asp?L=E&amp;M=$t/208-1-0-1/main_pages/../&amp;L=E&amp;M=$t/208-1-0-1/main_pages/levels.html" target="_blank" style="font-size:.7em;">__((*) Common European Framework of Reference (CEF) level)</a></i>
      </div>
     </div>
    </xsl:if>
     ...
     <div class="EuropassCV_ContentLineNewSection">
      ...
      <div class="EuropassCV_Content">
       <xsl:for-each select="hr:UserArea/hr:AdditionalInformations/hr:AdditionalInformation">
        <xsl:value-of select="php:function('KiteCVFile::nl2brAndLink', string(hr:Description))" disable-output-escaping="yes"/>
        <br/>
       </xsl:for-each>
      </div>
     </div>
 ...
 <xsl:template name="supportingMaterials">
  ...
  <xsl:for-each select="exslt:node-set($node)/*">
    <a target="_blank">
     <xsl:attribute name="href"><xsl:value-of select="hr:Link"/></xsl:attribute>
 ...
 <xsl:template name="workExperience">
  ...
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
     <xsl:value-of select="php:function('KiteCVFile::nl2brAndLink', string(exslt:node-set($node)/hr:EmployerOrg/hr:PositionHistory/hr:Description))" disable-output-escaping="yes"/>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   <div class="EuropassCV_HeaderColumn">
 ...
 <xsl:template name="degree">
  ...
  <div class="EuropassCV_ContentLine">
   ...
   <div class="EuropassCV_Content">
     <xsl:value-of select="php:function('KiteCVFile::nl2brAndLink', string(exslt:node-set($node)/hr:SchoolOrInstitution/hr:Degree/hr:Comments))" disable-output-escaping="yes"/>
   </div>
  </div>
  <div class="EuropassCV_ContentLine">
   <div class="EuropassCV_HeaderColumn">
  ...
  <div class="EuropassCV_ContentLine">
   <div class="EuropassCV_HeaderColumn">
    __(Level in national or international classification)
   </div>
   <div class="EuropassCV_Content">
   ...
   <div class="EuropassCV_ContentLine">
    ...
    <div class="EuropassCV_Content">
     <xsl:for-each select="hr:PreferredPosition/hr:Competency[@name=$name]">
      <p>
       <xsl:value-of select="php:function('KiteCVFile::nl2brAndLink', string(@description))" disable-output-escaping="yes"/>
      </p>
     </xsl:for-each>
    </div>
   </div>
